...
// verifica si el usuario es administrador (1 indica administrador)
?>
    ...
    <body>
        <div class="container">
            <div class="profile">
                ...
                <!-- Muestra informacion del usuario por la session -->
                ...
                <div class="user-menu">
                    ...
                    <!-- Botón "Listar Periféricos" solo para el administrador -->
                    <?php if ($is_admin): ?>
                        <div class="btn-box btns">
                            <a href="<?= base_url('listar') ?>">
                                <button type="submit" class="btn">Listar Periféricos</button>
                            </a>
                        </div>
                        <?php endif; ?>
